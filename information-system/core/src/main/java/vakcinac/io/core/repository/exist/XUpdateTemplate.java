...
public class XUpdateTemplate {
	 ...
	 * 
	 */
	public static String getInsertAfter(String targetNamespace) { 
	 ...
	 */
	public static String getInsertBefore(String targetNamespace) {
		return "<xu:modifications version=\"1.0\" xmlns:xu=\""
			+ XUpdateProcessor.XUPDATE_NS + "\" xmlns=\"" + targetNamespace + "\">"
	 ...
	 */
	public static String getAppend(String targetNamespace) {
	 ...
	 * node-set.
	 */
	public static String getUpdate(String targetNamespace) {
		return "<xu:modifications version=\"1.0\" xmlns:xu=\"" + XUpdateProcessor.XUPDATE_NS
	 ...
	 * to a node-set.
	 */
	public static String getRemove(String targetNamespace) {
		return "<xu:modifications version=\"1.0\" xmlns:xu=\"" + XUpdateProcessor.XUPDATE_NS
