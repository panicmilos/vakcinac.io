package vakcinac.io.citizen.security.utils;
...
public class JwtUtil {
    ...
    public String generateToken(Authentication authentication, String korisnickoIme, String gradjaninId) {
