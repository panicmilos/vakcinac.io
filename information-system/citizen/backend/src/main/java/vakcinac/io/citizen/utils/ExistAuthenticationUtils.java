package vakcinac.io.citizen.utils;

import java.io.IOException;
import java.io.InputStream;
import java.util.Properties;

public class ExistAuthenticationUtils {
	...
	private static InputStream openStream(String fileName) throws IOException {
		return ExistAuthenticationUtils.class.getClassLoader().getResourceAsStream(fileName);
	}
}
